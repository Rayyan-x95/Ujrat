...
export { PaymentService as PaymentVerificationService } from './services/PaymentService';
export { PaymentService as PaymentReceiptService } from './services/PaymentService';
export { PaymentService as PaymentAuditService } from './services/PaymentService';
