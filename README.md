...
Detailed technical specifications, architecture records, schema definitions, and design guidelines:

* 🏛️ **[System Architecture](docs/ARCHITECTURE.md)**: Clean DDD layering, state machines, and multi-tenant security model.
